...
export const VOICES: Record<LanguageKey, Voice[]> = {
  ...
  '🇫🇷 French': [{ id: 'ff_siwis', name: 'Siwis', gender: 'F' }],
  '🇮🇳 Hindi': [
...
export const SAMPLE_TEXTS: Record<LanguageKey, string> = {
  ...
  '🇬🇧 British English':
    'Good day! This is a demonstration of our sophisticated text-to-speech technology. Hear how natural and expressive our AI voices can be.',
  '🇯🇵 Japanese':
    'こんにちは！最先端のテキスト読み上げ技術へようこそ。自然で表現豊かなAI音声をお楽しみください。',
  '🇨🇳 Mandarin Chinese': '您好！欢迎使用我们先进的文本转语音平台。体验清晰自然的AI语音技术。',
  '🇪🇸 Spanish':
    '¡Hola! Bienvenido a nuestra plataforma avanzada de texto a voz. Experimenta el futuro de las voces generadas por IA con calidad cristalina.',
  '🇫🇷 French':
    "Bonjour ! Bienvenue sur notre plateforme avancée de synthèse vocale. Découvrez l'avenir des voix générées par IA avec une qualité exceptionnelle.",
  '🇮🇳 Hindi':
    'नमस्ते! हमारे उन्नत टेक्स्ट-टू-स्पीच प्लेटफॉर्म में आपका स्वागत है। प्राकृतिक AI आवाजों का अनुभव करें।',
  '🇮🇹 Italian':
    "Ciao! Benvenuto nella nostra piattaforma avanzata di sintesi vocale. Sperimenta il futuro delle voci generate dall'IA.",
  '🇧🇷 Portuguese':
    'Olá! Bem-vindo à nossa plataforma avançada de texto para fala. Experimente o futuro das vozes geradas por IA.',
};
